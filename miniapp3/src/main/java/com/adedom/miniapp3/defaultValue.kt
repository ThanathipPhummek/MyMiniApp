...
fun defaultValue3(){
    ...
    val newDefaultValue = DefaultValue(icon = "https://fastly.picsum.photos/id/28/4928/3264.jpg?hmac=GnYF-RnBUg44PFfU5pcw_Qs0ReOyStdnZ8MtQWJqTfA", appName = "มินิแอพ 3", deeplink = "bugaboo://mini-app-2?send=MINIAPP3")
